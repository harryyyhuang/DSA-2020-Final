...
void find_similarity(int i){
	...
	if(setSize[mid]>15 || queries[i].reward<60) return;
    ...
    for(int id=0;id<n_mails;id++){
        ...
        int minsize=min(setSize[mid],setSize[id]);
